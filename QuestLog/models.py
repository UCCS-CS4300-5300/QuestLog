...
from .utilities import validate_upload, secure_upload_wrapper
...
class UserPoints(models.Model):
    ...
    avatar = models.FileField(upload_to=secure_upload_wrapper('avatars'),blank=True,null=True,validators=[validate_upload]) 
...
class Task(models.Model):
    ...
    proofs = models.FileField(upload_to=secure_upload_wrapper('proofs'),blank=True,null=True,validators=[validate_upload]) #pictures of completed task
